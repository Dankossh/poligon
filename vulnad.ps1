#Base Lists 
$Global:HumansNames = @('Alikhan', 'Aruzhan', 'Bakyt', 'Dauren', 'Erlan', 'Kairat', 'Nursultan', 'Olzhas', 'Rasul', 'Timur', 'Yerbol', 'Zhandos', 'Aidar', 'Bolat', 'Esen', 'Marat', 'Ruslan', 'Serik', 'Yerlan', 'Zhanibek', 
'Almas', 'Askar', 'Bauyrzhan', 'Beksultan', 'Dias', 'Dosbol', 'Esenkhan', 'Gabiden', 'Gabit', 'Gabitkhan', 'Gaziz', 'Ilyas', 'Kenes', 'Kurmangazy', 'Madi', 'Maksat', 'Nurik', 'Omar', 'Rakhim', 'Rakhman', 'Salamat', 
'Sanzhar', 'Sapar', 'Talant', 'Talip', 'Yermakhan', 'Yertai', 'Zhaksybek', 'Zhanay', 'Zhanat', 'Zhantore', 'Aigerim', 'Altynai', 'Aruzhan', 'Dana', 'Gulnara', 'Madina', 'Nazerke', 'Raushan', 'Saule', 'Zhansaya', 
'Aigul', 'Balzhan', 'Dina', 'Gulmira', 'Kamila', 'Nazym', 'Raziya', 'Sholpan', 'Zhanel', 'Zhanara', 'Ainur', 'Alina', 'Amina', 'Anara', 'Asel', 'Asem', 'Asemgul', 'Azhar', 'Botagoz', 'Dariga', 'Dilnaz', 'Gaukhar', 
'Gulbahor', 'Gulzhan', 'Karlygash', 'Lyazzat', 'Madina', 'Maira', 'Makhabbat', 'Meruert', 'Nurgul', 'Perizat', 'Saltanat', 'Saniya', 'Svetlana', 'Tatyana', 'Tolganay', 'Zarina', 'Zhadyra', 'Zhaina', 'Zhannur', 
'Zhansulu', 'Zhansaya', 'Zhanar', 'Zhanerke', 'Zharaskhan', 'Zhasmina')
...
function Invoke-VulnAD {
    ...
    VulnAD-BadAcls
    Write-Good "MiddleComm{"
    VulnAD-Kerberoasting
    Write-Good "First: y0u_"
    VulnAD-ASREPRoasting
    Write-Good "Second: _h4ve"
    VulnAD-DnsAdmins
    Write-Good "Third: _Hack3d_"
    VulnAD-PwdInObjectDescription
    Write-Good "Fourth: th1s"
    VulnAD-DefaultPassword
    Write-Good "Fifth: _Machine_"
    VulnAD-PasswordSpraying
    Write-Good "`Zhangir like this method"
}
